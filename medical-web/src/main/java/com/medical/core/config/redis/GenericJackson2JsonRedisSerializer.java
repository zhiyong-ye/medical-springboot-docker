...
/**
 * GenericJackson2JsonRedisSerializer 自定义序列化
 *
 * @author ZHIYONG.YE
 * @email 773276516@qq.com
 * @date 2017年8月3日 下午5:19:42
 * @version 1.0
 * @param <T>
 */
public class GenericJackson2JsonRedisSerializer<T> implements RedisSerializer<T> {
    ...
    public T deserialize(byte[] source) throws SerializationException {
        return (T) deserialize(source, Object.class);
    }
